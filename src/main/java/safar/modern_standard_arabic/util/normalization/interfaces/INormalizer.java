...
public interface INormalizer {
     ...
     * @return a <tt>String</tt> containing the normalized text
     */
    String normalizeNonArabic(final String text);
     ...
     * @return a <tt>String</tt> containing the normalized text
     */
    String normalizeNumbers(final String text);
     ...
     * @return a <tt>String</tt> containing the normalized text
     */
    String normalizeWordsContainingDigits(final String text);
     ...
     * @return a <tt>String</tt> containing the normalized text
     */
    String normalizeSingleChar(final String text);
     ...
     * @return a <tt>String</tt> containing the normalized text
     */
    String normalizeDiacritics(final String text);
     ...
     * @return a <tt>String</tt> containing the normalized text
     */
    String normalizePunctuation(final String text);
